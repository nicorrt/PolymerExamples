...
class SwitchComponente extends LitElement {
  ...
  doClick() {
    ...
    this.dispatchEvent(new CustomEvent('switch-componente-checked', {
      bubbles: true,
      composed: true,
      detail: this.checked
    }));
...
customElements.define('switch-componente', SwitchComponente);
